  ...
  <div className="navbar">
    ...
    <Nav className="mr-auto">
      ...
      <Nav.Link href="#contacts">Contacts</Nav.Link>
        ...
        <a href="https://www.facebook.com/LenientPhotography" target="_blank"  style={{textDecoration:'none', color:'black'}}><Card style={{ width: '18rem', height:'25rem'}}>
...
<a href="https://www.instagram.com/lenient.photography/" target="_blank" style={{textDecoration:'none', color:'black'}}><Card style={{ width: '18rem', height:'25rem'}}>
...
<Card style={{ width: '18rem', height:'25rem'}}>
  ...
  <Card.Body>
    ...
    <Card.Text>
     Labiba Ferdous : 01716516488
     Email Address : labibaferdousema@gmail.com
    </Card.Text>
